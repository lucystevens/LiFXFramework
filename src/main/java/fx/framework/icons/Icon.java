...
/**
 * An enum to allow easy access and usage of all the FontAwesome icon
 * @author Luke Stevens
 */
public enum Icon {
	...
	/**
	 * Creates a new graphic for this icon.
	 * @param size The font size of this graphic in px
	 * @param backgroundColour The {@link ObservableRGBColour} of
	 ...
	 * @return The graphical representation of this icon, within a label.
	 */
	public Label graphic(int size, ObservableRGBColour backgroundColour){
		Label icon = new Label(unicode);
		StyleBuilder.styleNode(icon)
			.bindContrastProperty(CSSProperty.TEXT_FILL, backgroundColour)
			.replaceProperty(CSSProperty.FONT_SIZE, size + "px")
			.replaceProperty(CSSProperty.FONT_FAMILY, TypeFace.FONT_AWESOME.font)
			.build();
		return icon;
	}
	
	/**
	 * @return Get the basic unicode string
	 */
